...
\begin{tabular}{ll}
    \begin{minipage}[t]{3.75in}
        \section{Internship Experience}
            ...
            % TODO: See if this is an acceptable way to describe it
            Implemented a dashboard and alert system for a userdata database
            \begin{itemize}
                ...
                \item Simplified a MapReduce program for computing extra stats
            \end{itemize}
